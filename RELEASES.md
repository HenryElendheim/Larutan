...
New in this one, the full turn of a parting. When a camp breaks away, it now founds a
named place of its own -- a second settlement, set down in the chronicle as they make
it. And a parting need not be forever: if the two peoples wander back within sight of
one another, they come together again, one place once more, and that reunion is written
down too. A people can split, go its own way, and one day return.
...
New in this one, belief becomes something that draws a people together or sets it at
odds. A being's firmest conviction is now their creed, and it colours how they meet
each other: a shared conviction is a kinship that warms a bond faster, a differing one
a quiet friction that cools it. And when two real camps of belief take hold among a
settled people -- some holding one way, some another -- the group comes to see itself as
split, and that division is set down in the chronicle as it happens. The seed of factions.
...
New in this one, a god's reach extends to making and unmaking. New being, from the top
bar, calls a fresh soul into the world -- its own nature, arriving grown enough to live
at once -- and follows it, so you can shape it from there. And the Shape page ends with
Strike down, which takes the life you're holding outright: they die as any would,
weighed and settled into a realm, to be found again among the dead. Creation and its
opposite, to round out the godhood.
...
New in this one, you can see the land. The map is no longer an empty grid: water shows
as cool blue tiles, ground with food on it shows as living green that brightens with
how much is there, and the shelters the beings raise show as warm rounded marks -- so
you can finally see where they get water, where food grows, and the homes they make.
And they stop wasting materials on it: instead of scattering a dozen weak half-shelters,
a being tops up their own home first, then the nearest standing shelter that can still
be worked, and only starts a new one when there's nothing to reuse -- so the work goes
into making one place solid.
...
New in this one, the world grows a sense of place and of standing, and the app gets
a settings menu. A being now belongs somewhere -- the spot they raise a shelter, or
the one their parents held -- and being home settles them, while a home lost to the
weather is felt before it's let go. Deep in the cold seasons a hard spell can set in
for days, and it's where the shelter you built and the food you put by pay off: the
exposed suffer, the sheltered and stocked ride it out. And the group comes to regard
each being by what they're seen to do -- generosity, care and making peace lift you,
lashing out and breaking bonds lower you -- which colours how warmly others first take
to you; the panel reads it back as a healer, well-loved, or looked at warily.

The new settings menu, reached from the top bar, holds what you'd want: larger text
for easier reading, a switch to hide the moment banners, and -- the big one -- a way
to turn off the world slowing down for big moments, so you can blitz a long stretch
without births and deaths easing the speed back for you. Your choices are remembered.
...
New in this one: the beings grow a culture. They learn skills by doing and get
better at them, form beliefs from what they live, and elders pass both down to the
young -- a conviction can echo down a lineage. They share food with those they care
for, and one scarred by hunger hoards instead. Rarely, someone works out how to tend
the ground so it bears more, and that know-how spreads by being taught. The dead go
further too: a soul can be sent back into a new life, and the long-gone fade to an
epitaph. And whatever the speed, the moments that matter now surface, so you never
miss a birth, a death, or a goal reached.
...
New in this one: the dead are their own place now. You can browse them apart from
the living and filter them by realm -- heaven, hell, or purgatory -- follow a soul,
and read its final thought and the thoughts it carried. You can reverse time, too,
and roll the whole world back to an earlier moment. There's a slower "Dwell" speed
for lingering, the map zooms and pans, and the ageless are marked at a glance with
a clear on/off toggle.

## Larutan v0.1.1

Same world, with more to do in it. You can now reach in as a god -- provide food,
warm a being, bless them, inspire a purpose, or make one ageless -- and watch
their own nature take it from there. You can pick who to follow from a roster of
the living and the lost, and the world now saves itself and picks back up exactly
where you left it. Lives also reach for a wider range of goals than before.

## Larutan v0.1

Larutan is a dark-mode life-sim about a few small beings living their own lives.
It simulates their needs, feelings, memories and goals; it lets you follow any
one of them and read their whole inner life; and it runs a grounded world of
seasons where bonds form, generations are born, and lives end and are remembered.
